...
$sql = "SELECT count(id) FROM songtbl where `flag`='1' and `group` = 'پاپ'";
...
$sql = "SELECT * FROM songtbl where `flag`='1' and `group` = 'پاپ' ORDER BY `date` DESC LIMIT $offset, $rec_limit"; 
$retval = mysqli_query($conn, $sql);
